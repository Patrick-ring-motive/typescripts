! function(e, t) {
  ...
  Object.defineProperties(ReadableStreamDefaultReader.prototype, {
    ...
    configurable: !0
  }), "symbol" == typeof t.asyncIterator && (ee = {
    [t.asyncIterator]() {
      return this
    }
  }, Object.defineProperty(ee, t.asyncIterator, {
    enumerable: !1
  }));
  class te {
    constructor(e, t) {
    ...
    _nextSteps() {
      ...
      return K(e, {
        _chunkSteps: e => {
          this._ongoingPromise = void 0, S((() => t({
            value: e,
            done: !1
          })))
        },
  ...
  class ReadableByteStreamController {
    ...
    get byobRequest() {
      if (!be(this)) throw Ie("byobRequest");
      return Be(this)
    }
    get desiredSize() {
      if (!be(this)) throw Ie("desiredSize");
      return ke(this)
    }
    close() {
      if (!be(this)) throw Ie("close");
  ...
  function Te(e) {
    for (; e._pendingPullIntos.length > 0;) {
      ...
      ge(e, t) && (Pe(e), pe(e._controlledReadableByteStream, t))
    }
  }
  ...
  function We(e, t) {
    ...
    else Me(r) ? (Se(e, i, n, a), Te(e)) : Se(e, i, n, a);
    _e(e)
  }
  ...
  function Ye(e, t, r) {
    ...
    o._disturbed = !0, "errored" === o._state ? r._errorSteps(o._storedError) : function(e, t, r) {
      ...
      if (e._pendingPullIntos.length > 0) return e._pendingPullIntos.push(l), void Fe(o, r);
      if ("closed" !== o._state) {
        ...
        e._pendingPullIntos.push(l), Fe(o, r), _e(e)
      } else {
  ...
  function Ue(e, t) {
    return L(e, t), t => Q(e(t))
  }

  function Ge(e, t, r) {
    return L(e, r), r => v(e, t, [r])
  }
  ...
  function Je(e, t, r) {
    return L(e, r), r => g(e, t, [r])
  }

  function Ke(e, t, r) {
    return L(e, r), (r, o) => v(e, t, [r, o])
  }
  ...
  function it(e) {
    ...
    const r = c(((t, r) => {
      ...
      o = e._writer;
    var n;
    return void 0 !== o && e._backpressure && "writable" === t && $t(o), de(n = e._writableStreamController, St, 0), Tt(n), r
  }
  ...
  class WritableStreamDefaultWriter {
    constructor(e) {
      ...
      const t = e._state;
      if ("writable" === t) !ct(e) && e._backpressure ? Dt(this) : Lt(this), kt(this);
      else if ("erroring" === t) It(this, e._storedError), kt(this);
      else if ("closed" === t) Lt(this), kt(r = this), zt(r);
      else {
        const t = e._storedError;
        It(this, t), jt(this, t)
      }
  ...
  function mt(e, t) {
    "pending" === e._readyPromiseState ? Ft(e, t) : function(e, t) {
      It(e, t)
    }(e, t)
  }
  ...
  class WritableStreamDefaultController {
    ...
    get abortReason() {
      if (!gt(this)) throw Wt("abortReason");
      return this._abortReason
    }
    get signal() {
      if (!gt(this)) throw Wt("signal");
      if (void 0 === this._abortController) throw new TypeError("WritableStreamDefaultController.prototype.signal is not supported");
      return this._abortController.signal
    }
    error(e) {
      if (!gt(this)) throw Wt("error");
  ...
  function Yt(e, t, o, n, a, i) {
    ...
    return c(((S, g) => {
      ...
      function O(e, t) {
        pt(s), C(l), void 0 !== i && i.removeEventListener("abort", v), e ? g(t) : S(void 0)
      }
      y(c(((e, t) => {
        ! function o(n) {
  ...
  function tr(e, t) {
    return be(e._readableStreamController) ? function(e) {
        ...
        K(i, {
          _chunkSteps: t => {
            S((() => {
              ...
              f || We(o._readableStreamController, r), b || We(n._readableStreamController, i), l = !1, s ? g() : u && v()
            }))
          },
          _closeSteps: () => {
        ...
        Ye(i, t, {
          _chunkSteps: t => {
            S((() => {
              s = !1, u = !1;
              const o = r ? b : f;
              if (r ? f : b) o || Ae(c._readableStreamController, t);
              else {
                let r;
                try {
                  r = ue(t)
      ...
      function T() {}
      return o = ur(T, g, w), n = ur(T, v, R), _(i), [o, n]
    }(e) : function(e, t) {
      const r = H(e);
      let o, n, a, i, l, s = !1,
        u = !1,
      ...
      function g() {}
      return a = sr(g, _, p), i = sr(g, _, y), m(r._closedPromise, (e => {
  ...
  class ReadableStream {
    ...
    getReader(e) {
      ...
      }(e, "First parameter").mode ? H(this) : Le(this)
    }
    pipeThrough(e, t = {}) {
  ...
  class ByteLengthQueuingStrategy {
    ...
    get highWaterMark() {
      if (!gr(this)) throw Sr("highWaterMark");
      return this._byteLengthQueuingStrategyHighWaterMark
    }
    get size() {
      if (!gr(this)) throw Sr("size");
      return yr
    }
  }
  ...
  if (void 0 !== o)
    for (const e in Ir) Object.prototype.hasOwnProperty.call(Ir, e) && Object.defineProperty(o, e, {
      value: Ir[e],
      writable: !0,
      configurable: !0
    });
